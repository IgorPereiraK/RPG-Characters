        ...
        <button className="">
                    <Dialog>
                        <DialogTrigger className="w-[91px]">
                           <img src={armorDeVlad[selectedArmorIndex].imagem} alt={armorDeVlad[selectedArmorIndex].name} className="h-24 border-y-2 border-x-2 border-black w-full"/>
                        </DialogTrigger>
                                        ...
                                        {selectedArmorIndex !== null && (
                                            <div>
                                                <div className="flex gap-4">
                                                    <img src={armorDeVlad[selectedArmorIndex].imagem} alt={armorDeVlad[selectedArmorIndex].name} className="h-32 w-28"/>
                                                    <div>
                                                        <h3 className="text-2xl text-gray-100 font-bold mb-1">{armorDeVlad[selectedArmorIndex].name}</h3>
                                                        <p className="text-xl text-gray-100">{armorDeVlad[selectedArmorIndex].dano}</p>
                                                    </div>
                                                </div>
                                                <p className="text-gray-baldurText text-lg mt-4">{armorDeVlad[selectedArmorIndex].texto}</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
